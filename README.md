...
<p align="center">
<img src="https://skillicons.dev/icons?i=js,ts,react,nodejs,postgres,supabase,python,vscode,docker&theme=dark" />
</p>

**Orquestração & Automação** `n8n` `Make` `Typebot` `Z-API`
**IA** `OpenAI` `Claude` `Gemini` `RAG`
**Back-end & Cloud** `Supabase` `Node.js` `Edge Functions` `REST APIs`
**Banco de Dados** `PostgreSQL` `NocoDB` `PgVector`
**Front-end** `React` `React Flow` `Webhooks`
**Dev Tools** `VS Code` `Lovable` `Windsurf`
...
<p align="center">
<img height="165" src="https://github-readme-stats.vercel.app/api?username=Daniell-Santos&show_icons=true&theme=radical&hide_border=true" />
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Daniell-Santos&layout=compact&theme=radical&hide_border=true" />
</p>

<p align="center">
<img src="https://github-profile-trophy.vercel.app/?username=Daniell-Santos&theme=radical&no-frame=true&row=1&column=6" />
</p>

---

<p align="center">💬 Aberto a trocar ideia sobre automação, IA aplicada a negócios e hiperautomação. Manda uma mensagem!</p>
